...
// CMS后台管理系统静态页面路由
const articleList = Loadable({loader: () => import(/*webpackChunkName:'Bug'*/'@/views/cms/article/article-list'),loading: Loading});
const articleCreate = Loadable({loader: () => import(/*webpackChunkName:'Bug'*/'@/views/cms/article/article-create'),loading: Loading});
const articleRecycle = Loadable({loader: () => import(/*webpackChunkName:'Bug'*/'@/views/cms/article/article-recycle'),loading: Loading});
const ColumnCreate = Loadable({loader: () => import(/*webpackChunkName:'Bug'*/'@/views/cms/column/column-create'),loading: Loading});
const ColumnList = Loadable({loader: () => import(/*webpackChunkName:'Bug'*/'@/views/cms/column/column-list'),loading: Loading});
...
export default [
  ...
  // CMS后台管理系统静态页面路由
  { path: "/cms/article-list", component: articleList, roles: ["admin","editor","guest"] },
  { path: "/cms/article-create", component: articleCreate, roles: ["admin","editor","guest"] },
  { path: "/cms/article-recycle", component: articleRecycle, roles: ["admin","editor","guest"] },
  { path: "/cms/column-create", component: ColumnCreate, roles: ["admin","editor","guest"] },
  { path: "/cms/column-list", component: ColumnList, roles: ["admin","editor","guest"] },
